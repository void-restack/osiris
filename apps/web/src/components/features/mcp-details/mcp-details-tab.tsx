...
import { ServerList, type McpServer } from "./mcp-servers";
...
export function McpTabs() {
  return (
    <Tabs defaultValue="readme" className="w-full flex flex-col gap-y-8">
      <TabsList className="h-12 w-full flex py-0 justify-start border-b border-b-primary-100">
      ...
      <TabsContent value="readme"></TabsContent>
