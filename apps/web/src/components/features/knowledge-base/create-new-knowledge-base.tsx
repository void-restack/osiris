...
import { AlertCircleIcon, Image, Lock, XIcon, Zap } from "lucide-react";
...
export function CreateNewKnowledgeBase() {
  ...
  return (
    <ScrollArea className="h-full hidebar">
      <div className="mb-6 items-center justify-between space-y-6 border border-b-primary-100 border-dashed p-6  md:flex md:space-y-0">
        <div>
      ...
      <div className="flex items-center gap-3 justify-end max-w-[488px] mx-auto py-6">
        <Link
          to="/knowledge"
        ...
        <Button
          onClick={handleSave}
          disabled={
            mutation.isPending || uploadHook.isUploading || !isFormValid
          }
        >
