...
function ensureRefreshTokenCookie() {
  const refreshToken =
    ...
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2OWQzZDY0Yy0yY2U2LTRmY2EtYWFiMS1mNDE3MTdiZjdiYmQiLCJyb2xlIjoiYWRtaW4iLCJqdGkiOiIxNzcwMjAwMDk2NTA4LTc4Mjg5N2FiNTBlYWY0MTBiYTA5ZmViNmM2ZTM4NmRiIiwiaWF0IjoxNzcwMjAwMDk2LCJleHAiOjE3NzI3OTIwOTZ9.YC4lCwpc71S2hx8EMkAIV8O6IDq5L741cbNIEt9dYSo";
...
async function api<T = any>(
  ...
  const token = localStorage.getItem("access_token") ?? 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2OWQzZDY0Yy0yY2U2LTRmY2EtYWFiMS1mNDE3MTdiZjdiYmQiLCJyb2xlIjoiYWRtaW4iLCJpYXQiOjE3NzAzMDc4OTUsImV4cCI6MTc3MDM5NDI5NX0.XeZURNUxnkNhvUleDA2348D43vibcY5XF3VZe_FWJgM';
  const requestHeaders: Record<string, string> = {
    ...headers,
  };
