...
function ensureRefreshTokenCookie() {
  const refreshToken =
    ...
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIzODlmYzFkOS0yMTdjLTRmZmQtYTM3Ny0wNjQ2NjlmZjZhMDkiLCJyb2xlIjoiYWRtaW4iLCJqdGkiOiIxNzU1NDE2NjI1ODYxLWMzYTJiMGZlZjVhZTM3Y2M3ZjgzYmE1YmRmOGNlMmJkIiwiaWF0IjoxNzU1NDE2NjI1LCJleHAiOjE3NTgwMDg2MjV9.n2V7ihR7u20m3pSfAnLAgj2qO_yG8cPqHkSczv9ZR4k";
...
async function api<T = any>(
  ...
  const token = localStorage.getItem("access_token") ?? 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIzODlmYzFkOS0yMTdjLTRmZmQtYTM3Ny0wNjQ2NjlmZjZhMDkiLCJyb2xlIjoiYWRtaW4iLCJpYXQiOjE3NTU0MTY2MjUsImV4cCI6MTc1NTUwMzAyNX0.0VZ1gZBkz7cFGFt6TlvjQJmhUVV018LIXFlRJTiJNDM';
  const requestHeaders: Record<string, string> = {
    ...headers,
  };
