...
<Cards>
  <Card title="🔍 Authentication Deep Dive" href="/docs/sdk/authentication">
    Learn about multi-service OAuth patterns and security
  </Card>
  <Card title="🗄️ Database Integration" href="/docs/sdk/database">
    Master persistent state with database adapters
  </Card>
  <Card title="🛡️ Add Policy Enforcement" href="/docs/policy-engine">
